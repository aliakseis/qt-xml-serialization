...
{
	FactoryInterface(const QString& className) : m_className(className) {}
...
{
public:
	ClassFactory(const QString& className) : FactoryInterface(className) {}
...
{
public:
	AdvisingClassFactory(const QString& className) : FactoryInterface(className) {}
